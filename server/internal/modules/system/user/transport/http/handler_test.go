...
func TestMe(t *testing.T) {
	...
	NewHandler(application.NewService(nil, platformauth.NewBcryptPasswordHasher(), nil, false, nil)).Register(group)
...
func TestChangePassword(t *testing.T) {
	...
	group := engine.Group("/api")
	NewHandler(application.NewService(repo, fakeHasher{}, nil, false, nil)).Register(group)
